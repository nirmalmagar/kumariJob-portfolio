        ...
        <div className='xxl:px-[15%] xl:px-[10%] px-[6%] overflow-x-hidden pb-20 ' >
          ...
          <div className=' lgg:flex-row lgg:text-start text-center flex-col-reverse absolute top-16 llgg:top-32 flex lg:gap-x-40 lgg:gap-x-20 gap-x-5 mt-32'>
            <div className='text-white pt-10'>
              ...
              <h1 className='font-semibold md:text-6xl xs:text-5xl text-4xl '>Nirmal Magar</h1>
              <p className='text-xl my-6  '>A <span className='text-green-500 '>Front-end Developer</span> From <span className='text-blue-500'>Nepal </span></p>
              <p className='text-md '> I'm Front-end Developer based in Nepal, and I'm very passionate and dedicated to my work.</p>
